...
class SingleStageDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        # stu_tea_proposal = self.bbox_head.get_bboxes_KD(*stu_bbox_outs, *tea_bbox_outs, img_metas=img_metas,
        #                                            cfg=tea_proposal_cfg)
        # stu_tea_proposal, stu_proposal_gtlabels = self.bbox_head.get_bboxes_single_kd(*stu_bbox_outs, img_metas=img_metas,
        #                                            cfg=tea_proposal_cfg)
        # print(stu_proposal.size())
        # stu_tea_proposal = []
        #
        # for i in range(len(stu_proposal)):
        #     print(stu_proposal[i].size())
        #     stu_tea_proposal.append(stu_proposal[i][0])
